    ...
    , mCurrentTireIndex(0)
{
    ...
    if (!mBackgroundTexture.loadFromFile("game_bg.png")) {
        ...
        // Ã‡Ò¯Ú‡·ËÛÂÏ Í‡ÚËÌÍÛ ÔÓ‰ ‡ÁÂ¯ÂÌËÂ ÓÍÌ‡ 1280x720, 
        // ˜ÚÓ·˚ ÓÌ‡ Ë‰Â‡Î¸ÌÓ ‡ÒÚˇÌÛÎ‡Ò¸ ·ÂÁ ˜ÂÌ˚ı ÔÓÎÓÒ:
...
void Game::update(sf::Time deltaTime) {
    ...
    // œÂÂ‰‡ÂÏ deltaTime, ÌÓ ‚ÌÛÚË Rocket ÓÌ ÚÂÔÂ¸ Ë„ÌÓËÛÂÚÒˇ (ËÒÔÓÎ¸ÁÛÂÚÒˇ fixedDt)
...
void Game::render() {
    ...
    if (mCurrentState == GameState::PLAY) {
        // 1. œ≈–¬€Ã ƒ≈ÀŒÃ –»—”≈Ã Õ¿ÿ  –”“Œ… ‘ŒÕ
        mWindow.draw(mBackgroundSprite);

        // 2. ¬“Œ–€Ã ƒ≈ÀŒÃ –»—”≈Ã ÷≈À» (ÓÌË ·Û‰ÛÚ ÎÂÚ‡Ú¸ ÔÓ‚Âı Á‡‰ÌÂ„Ó ÙÓÌ‡)
